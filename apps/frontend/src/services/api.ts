...
export const articlesAPI = {
   ...
   */
  list: async (limit = 20, offset = 0): Promise<PaginatedResponse<Article>> => {
...
export const analysisAPI = {
   ...
   */
  analyzeText: async (data: AnalyzeTextRequest): Promise<Analysis> => {
   ...
   */
  analyzeImage: async (data: AnalyzeImageRequest): Promise<Analysis> => {
   ...
   * Get recent analyses
   */
  getRecent: async (limit = 10, offset = 0): Promise<PaginatedResponse<Analysis>> => {
